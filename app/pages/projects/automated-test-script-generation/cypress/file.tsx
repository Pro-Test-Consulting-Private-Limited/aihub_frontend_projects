  ...
  return (
    <div key={file.path}>
      ...
      >
        ...
        <div
          title={file.name}
          className={`text-[14px] font-[500] text-[#5E6066] my-[8px] ml-[8px] whitespace-nowrap ${
            generatedFiles?.includes(file.name) ? "text-[green]" : ""
          } ${file.path === selectedFile ? "text-[#8664F2]" : ""} px-1 rounded`}
        >
          {file.name}
        </div>
